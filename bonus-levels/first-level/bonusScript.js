...
/*checkFlipCode checks to see is the input box behind the flip box has the proper code of "eues" and see if the boxFall animation has already
...
/*solveCipher has two roles, first is to check whether the Ceasar Cipher has been cracked and typed into the lock1 box, and it also checks
...
/*The rearrangeUnder checks for the word "speedup" which is found when rearranging the underlined letters throughout the page, if the 
